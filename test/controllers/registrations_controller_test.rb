...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { employee_id: @registration.employee_id, trial_id: @registration.trial_id } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { employee_id: @registration.employee_id, trial_id: @registration.trial_id } }
